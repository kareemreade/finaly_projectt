                ...
                <div class="container p-4">
                    ...
                    <form action="{{ route('admin.Skills.store') }}" method="POST" >
                                ...
                                <div class="mb-3">
                                    ...
                                    <input style=" background-color: #e8e8ff;" type="text" class="form-control  @error('title_Skils') is-invalid @enderror" id="Title_Skils" name="title_Skils" placeholder="Enter Title_Skils ....">
                                    @error('title_Skils')
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <input style=" background-color: #e8e8ff;" type="number" class="form-control @error('ValueOf_Skils') is-invalid @enderror" id="ValueOf_Skils" name="ValueOf_Skils" placeholder="Enter ValueOf_Skils ...." >
                                    @error('ValueOf_Skils')
                                    <strong class=" invalid-feedback">
                                        {{$message}}
                                    </strong>
