...
@section('contian')
    ...
    <div class="col-md-9" style="padding-left: 150px">
        ...
        <h2 class="mt-5 mb-5">editPortfolio_web</h2>
                ...
                <div class="container p-4">
                    ...
                    <form action="{{ route('admin.Portfolio.update',$Portfolios->id) }}" method="POST" enctype="multipart/form-data" >
                                ...
                                <div class="mb-3">
                                    ...
                                    <input style=" background-color: #e8e8ff;" type="text" class="form-control  @error('name') is-invalid @enderror" id="Title" name="name" placeholder="Enter name ...." value="{{ $Portfolios->name }}">
                                    @error('name')
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <img src="{{ asset('uplodesPortfolio/'.$Portfolios->imge) }}" width="100" alt="" srcset="">
                                </div>
                                <div class="mb-3">
                                    <label for="end_date" class="form-label">Link</label>
                                    <input  style=" background-color: #e8e8ff;" type="url"class="form-control @error('link') is-invalid @enderror"id="end_date" name="link" placeholder="kareem@gmil.com" value="{{ $Portfolios->link }}">
                                    @error('link')
                                    <strong class=" invalid-feedback">
                                        {{$message}}
                                    </strong>
